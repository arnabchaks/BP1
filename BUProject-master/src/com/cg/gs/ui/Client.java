...
public class Client {
	...
	public static void main(String[] args) {
		...
		/*
		 * try { System.out.println(gss.getGameInfo(Football));
		 * System.out.println(gss.getPlayerInfo(Vinay)); } catch (NotFoundException e) {
...
/*
 * int choice = 0; Scanner sc; while (choice!=7) { sc = new Scanner(System.in);
 * System.out.
 * println("****Menu**** \n1. Add player \n2. Add Game \n3. Add day \n4. Get Player Info \n5. Get Game Info \n6. Get Day Info \n7. Exit"
 * ); choice = sc.nextInt(); switch (choice) { case 1:
 * System.out.println("Enter player name: "); String playerName = sc.nextLine();
 * System.out.println("Enter games to be played: "); Set<Game> games = new
 * HashSet<Game>(); games = sc.nextSet break;
 * 
 * default: break;
 */